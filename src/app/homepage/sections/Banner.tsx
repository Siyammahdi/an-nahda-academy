    ...
    return (
        <div className=' relative h-[70vh] w-fit mx-5'>
            ...
            <div className=''>
                ...
                <div className="absolute select-none z-20 w-16 lg:w-28 top-3/4 left-[150px] lg:left-[400px] transform translate-x-1/2 -translate-y-1/2">
                    <motion.div
                        animate={{
                ...
                <div className="absolute select-none z-20 w-16 lg:w-36 top-[20%] left-10 lg:-left-10 transform -translate-x-1/2 -translate-y-1/2">
                    <motion.div
                        animate={{
            ...
            <div className="absolute w-[300px] lg:w-[600px] top-36 md:top-60 text-left">
                <div className='text-blue-950 dark:text-white'>
                    <h3 className='mb-4 text-violet-400 text-medium select-none'>শুরু হোক জ্ঞানযাত্রা এখন থেকেই</h3>
                    <h1 className='text-2xl md:text-4xl lg:text-5xl font-semibold select-none leading-relaxed' ><span>ইলমের আলোয় জাগরূক</span> <span className='select-none'>জীবনের প্রত্যয়...</span></h1>
                </div>
