               ...
               <SwiperSlide className="" key={index}>
                  <div className="relative z-20 md:w-fit space-y-3 rounded-[36px] bg-white p-4 shadow-lg my-10 dark:bg-[#18181B]">
                     <div className="relative flex h-48 w-full justify-center lg:h-[260px]">
                        <div className="absolute left-4 right-4 top-4 flex items-center justify-between">
                           <div className="flex items-center">
                              <svg
                                 width={30}
                                 className="cursor-pointer fill-transparent stroke-white stroke-2 hover:fill-violet-500 hover:stroke-violet-500"
                                 viewBox="0 0 24 24"
                     ...
                     <div className="flex flex-row items-center justify-between gap-6 text-sm md:text-base">
                        ...
                        <button className="rounded-full text-xs md:text-sm bg-gray-400 px-4 py-2 font-semibold text-white duration-300 hover:scale-95 hover:bg-gray-600">
                           Add to Cart
                        </button>
                     </div>
                  </div>
