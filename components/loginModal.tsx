                           ...
                           >
                              ...
                              <Input
                                 ...
                                 endContent={
                                    ...
                                    >
                                       {!showPassword ? (
                                          <FaRegEyeSlash className="text-2xl text-default-400 pointer-events-none flex-shrink-0" />
                                       ) : (
                                          <FaRegEye className="text-2xl text-default-400 pointer-events-none flex-shrink-0" />
                                       )}
                                    </span>
